...
> 
> REQUIREMENTS  return
> Package as a gem  return
> Provide a CLI on gem installation.    return
> CLI must provide data from an external source, whether scraped or via a public API.    return
> Data provided must go at least a level deep, generally by showing the user a list of available data and then being able to drill into a specific item.   return   
> 
